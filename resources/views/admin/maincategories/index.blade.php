                                ...
                                <div class="card-content collapse show">
                                    ...
                                    @isset($categories)
                                        @foreach($categories as $category)
                                            <tr>
                                                <td>{{$category->name}} </td>
                                                <td>{{__('messages.'. get_default_lang())}} </td>
                                                <td>{{$category->getActive()}}</td>
                                                <td><img src="{{$category->photo}}" width="150" height="100"></td>
                                                <td>
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <a href=""
                                                           class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">إالغاء تفعيل</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
